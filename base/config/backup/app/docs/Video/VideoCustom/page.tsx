            ...
            <section className="flex flex-col items-center justify-center">
                <div className="max-w-screen-4xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
                    <div className="max-w-screen-2xl">
                        <h2 className="text-3xl font-bold sm:text-4xl text-red-600">Viewing YtDlx.VideoOnly.Single.Custom()</h2>
                        ...
                        <ul className="list-disc m-4 bg-neutral-800/40 shadow-black shadow-2xl p-8 rounded-3xl border border-dashed border-red-600">
                            ...
                            <li>@param resolution - The desired resolution of the video. options: 144p, 240p, 360p, 480p, 720p, 1080p, 1440p, 2160p, 3072p, 4320p, 6480p, 8640p, 12000p.</li>
                            ...
                            <li>
                                @returns A Promise that resolves when the video has been processed, unless `stream` is `true`, in which case it resolves with an object containing the `ffmpeg` command
                                and the `filename`.
                            </li>
                        </ul>
                        <AnimatePresence>
