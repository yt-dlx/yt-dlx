   ...
   <section className="flex flex-col items-center justify-center">
    <div className="max-w-screen-4xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
     <div className="max-w-screen-2xl">
      <h2 className="text-3xl font-bold sm:text-4xl text-red-600">Viewing YtDlx.AudioOnly.Single.Custom()</h2>
      ...
      <ul className="list-disc m-4 bg-neutral-800/40 shadow-black shadow-2xl p-8 rounded-3xl border border-dashed border-red-600">
       <li>Downloads and processes a single YouTube video with audio customization options.</li>
       ...
       <li>
        @param filter - (optional) The audio filter to apply. Available options: echo, slow, speed, phaser, flanger, panning, reverse, vibrato, subboost, surround, bassboost, nightcore, superslow,
       ...
       <li>@param resolution - The desired audio resolution. Available options: high, medium, low, ultralow.</li>
       <li>@returns A Promise that resolves with either `void` (if `stream` is false) or an object containing the `ffmpeg` instance and the output filename (if `stream` is true).</li>
      </ul>
      <AnimatePresence>
