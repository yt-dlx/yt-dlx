...
export default function RootLayout({ children }: { children: React.ReactNode }) {
 return (
  <html lang="en">
   <body className={`font-JosefinSansRegular ${AspireDemibold.variable} ${JosefinSansRegular.variable} ${JosefinSansSemibold.variable} ${JosefinSansLight.variable} ${JosefinSansBold.variable}`}>
