                ...
                <div className="mockup-window rounded-3xl shadow-xl shadow-black border border-[#e73d75]/20 bg-neutral-950/80">
                    <div className="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-16 lg:py-24">
                            ...
                            <div className="relative inline-flex items-center mx-auto align-middle mt-8">
                                <div className="text-center">
                                    ...
                                    <p className="max-w-6xl mx-auto text-sm leading-relaxed text-orange-50/80">
                                        Discover the limitless rhythm of Mixly: your go-to platform for free, unlimited streaming and downloading of music and videos. Immerse yourself in a diverse
                                        collection of tunes, from classics to the latest hits. Elevate your experience by syncing playlists and playing music together with multiple listeners. Mixly is
                                        not just a service; it&apos;s a shared symphony of sound. Enjoy the freedom to explore, connect, and create unforgettable moments—all at your fingertips. Mixly,
                                        where the beat never stops, and the experience is always in tune with your passion for music and videos.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <form
                            ...
                            <p className="text-orange-50/80">Elevate your vibe: Craft a personalized room for music magic with your favorite crew. Unleash unforgettable moments in harmony!</p>
                        ...
                        <form
                            ...
                            <p className="text-orange-50/80">
                                Immerse yourself in instant musical camaraderie! Jump into a curated room, groove with your favorite crew, and share sonic bliss together in a pre-made room.
                            </p>
                            <ul className="text-[#e73d75] list-decimal ml-4">
