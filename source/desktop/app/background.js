(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("ws"), require("electron-serve"), require("electron-store"));
	else if(typeof define === 'function' && define.amd)
		define(["ws", "electron-serve", "electron-store"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("ws"), require("electron-serve"), require("electron-store")) : factory(root["ws"], root["electron-serve"], root["electron-store"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(global, (__WEBPACK_EXTERNAL_MODULE_ws__, __WEBPACK_EXTERNAL_MODULE_electron_serve__, __WEBPACK_EXTERNAL_MODULE_electron_store__) => {
...
(async () => {
  ...
  server = new (ws__WEBPACK_IMPORTED_MODULE_1___default())("ws://localhost:" + port);
  ...
  if (production) electron_serve__WEBPACK_IMPORTED_MODULE_3___default()({
    directory: "app"
  });else electron__WEBPACK_IMPORTED_MODULE_5__.app.setPath("userData", electron__WEBPACK_IMPORTED_MODULE_5__.app.getPath("userData") + " (development)");
  await electron__WEBPACK_IMPORTED_MODULE_5__.app.whenReady();
  var mainwindow = (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.createWindow)("main", {
    show: true,
    fullscreen: true,
...
//
//
electron__WEBPACK_IMPORTED_MODULE_5__.ipcMain.handle("select-output-folder", async event => {
  var result = await electron__WEBPACK_IMPORTED_MODULE_5__.dialog.showOpenDialog({
    properties: ["openDirectory"]
  });
  if (result.canceled) return null;else return result.filePaths[0];
});
//
//

electron__WEBPACK_IMPORTED_MODULE_5__.ipcMain.on("SearchVideos", (event, response) => {
  server.send(_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()({
    event: "SearchVideos",
    payload: response
  }));
...
electron__WEBPACK_IMPORTED_MODULE_5__.ipcMain.on("VideoData", (event, response) => {
  server.send(_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()({
    event: "VideoData",
    payload: response
  }));
...
electron__WEBPACK_IMPORTED_MODULE_5__.ipcMain.on("AudioLowest", (event, response) => {
  server.send(_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()({
    event: "AudioLowest",
    payload: response
  }));
...
electron__WEBPACK_IMPORTED_MODULE_5__.ipcMain.on("AudioHighest", (event, response) => {
  server.send(_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()({
    event: "AudioHighest",
    payload: response
  }));
...
electron__WEBPACK_IMPORTED_MODULE_5__.ipcMain.on("VideoLowest", (event, response) => {
  server.send(_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()({
    event: "VideoLowest",
    payload: response
  }));
...
electron__WEBPACK_IMPORTED_MODULE_5__.ipcMain.on("VideoHighest", (event, response) => {
  server.send(_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()({
    event: "VideoHighest",
    payload: response
  }));
...
electron__WEBPACK_IMPORTED_MODULE_5__.ipcMain.on("AudioVideoLowest", (event, response) => {
  server.send(_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()({
    event: "AudioVideoLowest",
    payload: response
  }));
  server.on("message", output => {
    var {
...
electron__WEBPACK_IMPORTED_MODULE_5__.ipcMain.on("AudioVideoHighest", (event, response) => {
  server.send(_babel_runtime_corejs3_core_js_stable_json_stringify__WEBPACK_IMPORTED_MODULE_0___default()({
    event: "AudioVideoHighest",
    payload: response
  }));
  server.on("message", output => {
    var {
...
//
//
electron__WEBPACK_IMPORTED_MODULE_5__.app.on("window-all-closed", () => electron__WEBPACK_IMPORTED_MODULE_5__.app.quit());
})();
