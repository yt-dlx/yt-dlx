          ...
          <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center space-y-4">
              ...
              <motion.ul className="grid gap-2 py-4" {...AndBounce}>
                <li>
                  <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> Downloads or streams the highest quality audio from YouTube with filter options.
                </li>
                <li>
                ...
                <ul className="grid gap-2 pl-6">
                  ...
                  <li>
                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> @param options.filter - (optional) A filter to potentially apply. Note: Actual application of filters might
                    not work as expected. Cannot be used with <code>metadata: true</code>. Available: &quot;invert&quot;, &quot;rotate90&quot;, &quot;rotate270&quot;, &quot;grayscale&quot;,
            ...
            <motion.div
              ...
              {...FromRightToLeft}>
              <MdHighQuality className="w-48 h-48 text-red-700/70" />
            </motion.div>
          </div>
        </div>
      </motion.section>
