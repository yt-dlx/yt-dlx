          ...
          <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center space-y-4">
              ...
              <motion.ul className="grid gap-2 py-4" {...AndBounce}>
                <li>
                  <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> Extracts comprehensive information about a YouTube video.
                </li>
                <li>
                ...
                <ul className="grid gap-2 pl-6">
                  ...
                  <li>
                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> @param options.useTor - (optional) Whether to use Tor for certain requests.
                  </li>
                  <li>
                ...
                <li>
                  <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> @returns An EventEmitter instance for handling events during the extraction process.
                </li>
                <ul className="grid gap-2 pl-6">
                  <li>
                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> Emits &quot;data&quot; on success: A comprehensive object with video formats, metadata, comments, and
                    transcript.
                  </li>
                  <li>
                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> Emits &quot;error&quot;: Error message on failure.
                  </li>
                </ul>
              </motion.ul>
            ...
            <motion.div
              ...
              {...FromRightToLeft}>
              <MdInfo className="w-48 h-48 text-red-700/70" />
            </motion.div>
          </div>
        </div>
      </motion.section>
