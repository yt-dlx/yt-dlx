          ...
          <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center space-y-4">
              ...
              <motion.ul className="grid gap-2 py-4" {...AndBounce}>
                <li>
                  <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> Searches for YouTube playlists based on a query string.
                </li>
                <li>
                  <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> This function performs a search on YouTube for playlists using a given query string and returns the data of
                  the first playlist found.
                </li>
                <li>
                ...
                <ul className="grid gap-2 pl-6">
                  <li>
                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> @param options.playlistLink - The search query string for playlists (e.g., &quot;lofi hip hop
                    playlist&quot;). <strong>Required</strong>. Minimum length of 2 characters.
                  </li>
                </ul>
                <li>
                  <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> @returns An EventEmitter instance for handling events during the playlist search.
                </li>
                <ul className="grid gap-2 pl-6">
                  <li>
                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> Emits &quot;data&quot; on success: Object containing details about the first matching playlist (ID, title,
                    video count, thumbnails).
                  </li>
                  <li>
                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> Emits &quot;error&quot;: Error message (validation, input is ID, no playlists found, internal issue) on
                    failure.
                  </li>
                </ul>
              </motion.ul>
            ...
            <motion.div
              ...
              {...FromRightToLeft}>
              <MdPlaylistPlay className="w-48 h-48 text-red-700/70" />
            </motion.div>
          </div>
        </div>
      </motion.section>
