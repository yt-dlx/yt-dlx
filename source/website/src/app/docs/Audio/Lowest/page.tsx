          ...
          <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
            <div className="flex flex-col justify-center space-y-4">
              ...
              <motion.ul className="grid gap-2 py-4" {...AndBounce}>
                <li>
                  <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> Downloads or streams the lowest quality audio from YouTube.
                </li>
                <li>
                ...
                <ul className="grid gap-2 pl-6">
                  ...
                  <li>
                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> Emits &quot;metadata&quot; (if <code>metadata: true</code>): Video metadata, lowest audio format, suggested
                    filename.
                  </li>
                  <li>
