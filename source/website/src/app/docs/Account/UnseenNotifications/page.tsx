                ...
                <div className="flex items-start">
                  ...
                  <div className="flex flex-wrap w-full">
                    ...
                    <p className="text-neutral-400 w-full flex flex-wrap">
                      On success: object containing status and the fetched count (<code className="bg-neutral-800 px-1 py-0.5 rounded text-green-400 whitespace-pre-wrap">data.data.count</code>
                      ).
                    </p>
                  </div>
                </div>
