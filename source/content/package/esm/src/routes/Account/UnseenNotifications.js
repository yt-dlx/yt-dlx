 ...
 *
 */
export default function unseen_notifications(options) {
    ...
    (async () => {
        try {
            ...
            if (verbose)
                console.log(colors.green("@info:"), "Fetching unseen notifications...");
            if (!cookies) {
            ...
            if (verbose)
                console.log(colors.green("@info:"), "Unseen notifications fetched!");
