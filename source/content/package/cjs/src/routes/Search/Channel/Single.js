...
exports.default = channel_data;
const colors_1 = __importDefault(require("colors"));
const zod_1 = require("zod");
const youtubei_1 = require("youtubei");
const events_1 = require("events");
const ZodSchema = zod_1.z.object({ channelLink: zod_1.z.string().min(2) });
/**
 ...
 *
 */
function channel_data({ channelLink }) {
    ...
    (async () => {
        try {
            ...
            if (!channelData) {
                emitter.emit("error", `${colors_1.default.red("@error: ")} Unable to fetch channel data for the provided link.`);
                return;
            }
