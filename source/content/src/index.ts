...
import list_formats from "./routes/Info/Formats";
...
import video_comments from "./routes/Info/Comments";
...
import video_transcript from "./routes/Info/Transcript";
...
var YouTubeDLX = {
  ...
  Account: { History: watch_history, HomeFeed: home_feed, SubscriptionsFeed: subscriptions_feed, UnseenNotifications: unseen_notifications },
