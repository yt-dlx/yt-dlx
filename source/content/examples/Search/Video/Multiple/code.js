...
YouTubeDLX.Search.Video.Multiple({}).on("error", error => console.error("Expected Error (missing query):", error));
...
YouTubeDLX.Search.Video.Multiple({ query: "test", orderBy: "popular" }).on("error", error => console.error("Expected Error (invalid orderBy):", error));
