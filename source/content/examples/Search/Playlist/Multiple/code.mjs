...
YouTubeDLX.Search.Playlist.Multiple({ playlistLink: "a" }).on("error", error => console.error("Expected Error (short query):", error));
...
YouTubeDLX.Search.Playlist.Multiple({}).on("error", error => console.error("Expected Error (missing playlistLink):", error));
