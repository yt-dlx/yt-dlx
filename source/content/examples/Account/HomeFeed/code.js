...
YouTubeDLX.Account.HomeFeed({}).on("error", error => console.error("Expected Error (missing cookies):", error));

// 12. Invalid 'sort' value (will result in an error - Zod validation)
YouTubeDLX.Account.HomeFeed({ cookies: "YOUR_COOKIES_HERE", sort: "invalid_sort" }).on("error", error => console.error("Expected Error (invalid sort):", error));
