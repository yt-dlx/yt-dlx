...
YouTubeDLX.Video.Highest({}).on("error", error => console.error("Expected Error (missing query):", error));

// 18. Invalid 'filter' value (will result in an error - Zod validation)
YouTubeDLX.Video.Highest({ query: "your search query or url", filter: "nonexistentfilter" }).on("error", error => console.error("Expected Error (invalid filter):", error));
