...
YouTubeDLX.Video.Lowest({}).on("error", error => console.error("Expected Error (missing query):", error));

// 18. Invalid 'filter' value (will result in an error - Zod validation)
YouTubeDLX.Video.Lowest({ query: "your search query or url", filter: "nonexistentvideofilter" }).on("error", error => console.error("Expected Error (invalid filter):", error));
