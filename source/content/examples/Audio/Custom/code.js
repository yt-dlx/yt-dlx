...
YouTubeDLX.Audio.Custom({ resolution: "high" }).on("error", error => console.error("Expected Error (missing query):", error));

// 18. Missing required 'resolution' parameter (will result in an error - Zod validation)
YouTubeDLX.Audio.Custom({ query: "your search query or url" }).on("error", error => console.error("Expected Error (missing resolution):", error));

// 19. Invalid 'resolution' value (will result in an error - Zod validation)
YouTubeDLX.Audio.Custom({ query: "your search query or url", resolution: "superhigh" }).on("error", error => console.error("Expected Error (invalid resolution):", error));

// 20. Invalid 'filter' value (will result in an error - Zod validation)
YouTubeDLX.Audio.Custom({ query: "your search query or url", resolution: "high", filter: "nonexistentfilter" }).on("error", error => console.error("Expected Error (invalid filter):", error));
