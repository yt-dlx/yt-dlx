...
export default function AudioVideoLowest(): JSX.Element {
  return (
    <react.Fragment>
                ...
                <div className="grid grid-cols-1">
                  <div className="w-full max-w-lg mx-auto my-4 bg-neutral-800 shadow-xl rounded-xl">
                    ...
                    <div className="p-6 lg:text-center">
                      ...
                      <div className="mt-6">
                        <a
                          href="https://github.com/yt-dlx/yt-dlx/blob/main/examples/typescript/AudioVideo/single.lowest.test.ts"
                  ...
                  <div className="w-full max-w-lg mx-auto my-4 bg-neutral-800 shadow-xl rounded-xl">
                    ...
                    <div className="p-6 lg:text-center">
                      ...
                      <div className="mt-6">
                        <a
                          href="https://github.com/yt-dlx/yt-dlx/blob/main/examples/javascript/AudioVideo/single.lowest.test.js"
                          className="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-red-900 rounded-xl hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                        >
                          View profile
                        </a>
                  ...
                  <div className="w-full max-w-lg mx-auto my-4 bg-neutral-800 shadow-xl rounded-xl">
                    ...
                    <div className="p-6 lg:text-center">
                      ...
                      <div className="mt-6">
                        <a
                          href="https://github.com/yt-dlx/yt-dlx/blob/main/examples/ecmascript/AudioVideo/single.lowest.test.mjs"
                          className="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-red-900 rounded-xl hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                        >
                          View profile
                        </a>
