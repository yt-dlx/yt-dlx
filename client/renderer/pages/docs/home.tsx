                ...
                <div className="container px-4 md:px-6">
                    <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
                        <div className="flex flex-col justify-center space-y-4">
                            <motion.div className="inline-block rounded-3xl bg-red-600 text-neutral-900 cursor-not-allowed font-black px-3 py-1 text-sm">Viewing Documentation For:</motion.div>
                            ...
                            <motion.div className="overflow-x-auto" {...AndBounce}>
                                <table className="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <Link href="/docs/Audio/AudioCustom" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Audio/AudioHighest" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Audio/AudioLowest" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Video/VideoCustom" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Video/VideoHighest" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Video/VideoLowest" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/AudioVideo/AudioVideoCustom" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                                    AudioVideo.Single.Custom()
                                                </Link>
                                            </td>
                                            <td className="italic">Downloads audio and video from a YouTube video URL with customizable options such as resolution and filters.</td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <Link href="/docs/AudioVideo/AudioVideoHighest" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/AudioVideo/AudioVideoLowest" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Command/extract" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                                    info.extract()
                                                </Link>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Command/list_formats" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                                    info.list_formats()
                                                </Link>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Command/playlist_data" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Command/search_playlist" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Command/search_videos" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                        ...
                                        <tr>
                                            <td>
                                                <Link href="/docs/Command/video_data" className="font-bold flex items-center justify-center gap-2 hover:text-red-600">
                                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
