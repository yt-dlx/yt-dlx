                        ...
                        <div className="flex flex-col justify-center space-y-4">
                            ...
                            <motion.div className="flex flex-wrap gap-2">
                                <button
                                    ...
                                    onClick={() => {
                                        window.open(
                                            "https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/typescript/Audio/single.lowest.test.ts",
                                            "_blank"
                                        );
                                    }}
                                >
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        window.open(
                                            "https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/javascript/Audio/single.lowest.test.js",
                                            "_blank"
                                        );
                                    }}
                                >
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        window.open(
                                            "https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/ecmascript/Audio/single.lowest.test.mjs",
                                            "_blank"
                                        );
                                    }}
                                >
