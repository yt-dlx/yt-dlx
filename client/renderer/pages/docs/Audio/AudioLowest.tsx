                    ...
                    <div className="grid items-center gap-6 lg:grid-cols-2 lg:gap-12">
                        <div className="flex flex-col justify-center space-y-4">
                            ...
                            <motion.ul className="grid gap-2 py-4" {...AndBounce}>
                                ...
                                <li>
                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                    @param filter - (optional) The audio filter to apply. Available options: echo, slow, speed, phaser, flanger, panning, reverse, vibrato, subboost, surround,
                                    bassboost, nightcore, superslow, vaporwave, superspeed.
                                </li>
                                <li>
                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                ...
                                <li>
                                    <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-600" />
                                    @returns A Promise that resolves with either `void` (if `stream` is false) or an object containing the `ffmpeg` instance and the output filename (if `stream` is
                                    true).
                                </li>
                            </motion.ul>
