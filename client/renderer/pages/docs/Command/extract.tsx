                        ...
                        <div className="flex flex-col justify-center space-y-4">
                            ...
                            <motion.div className="flex flex-wrap gap-2">
                                <button
                                    ...
                                    onClick={() => {
                                        window.open(
                                            "https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/typescript/Command/extract.test.ts",
                                            "_blank"
                                        );
                                    }}
                                >
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        window.open(
                                            "https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/javascript/Command/extract.test.js",
                                            "_blank"
                                        );
                                    }}
                                >
                                ...
                                <button
                                    ...
                                    onClick={() => {
                                        window.open(
                                            "https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/ecmascript/Command/extract.test.mjs",
                                            "_blank"
                                        );
                                    }}
                                >
