    ...
    <motion.div
     ...
     <div
      ...
      <ul className="font-semibold list-disc text-white m-10 text-xl">
       <li onClick={() => _quality("AudioHighest")} className={`hover:text-red-600 text-2xl cursor-pointer italic ${quality === "AudioHighest" ? "text-red-600" : "text-white/60"}`}>
       ...
       <React.Fragment>
        <form
         ...
         <div className="flex flex-row space-x-4 mb-4">
          ...
          <label>
           <input name="metadata" type="checkbox" checked={formData.metadata} onChange={InputChange} className="checkbox checkbox-xs checkbox-error mr-2 bg-neutral-800" />
           Get Metadata
          </label>
         </div>
