                  ...
                  <div className="overflow-x-auto">
                    <section className="max-w-screen-2xl px-6 mx-auto p-1">
                      ...
                      <ul className="text-white font-semibold p-1 mb-4 text-sm">
                        <li>
                          <span className="text-red-600 font-black text-lg">@videoId:</span>{" "}
                          {TubeSearch.id}
                        </li>
                        <li>
                          <span className="text-red-600 font-black text-lg">@channelid:</span>{" "}
                          {TubeSearch.channelid}
                        </li>
                        <li>
                          <span className="text-red-600 font-black text-lg">@channelname:</span>{" "}
                          {TubeSearch.channelname}
                        </li>
                        <li>
                          <span className="text-red-600 font-black text-lg">@duration:</span>{" "}
                          {TubeSearch.duration}
                        </li>
                        <li>
                          <span className="text-red-600 font-black text-lg">@uploadDate:</span>{" "}
                          {TubeSearch.uploadDate}
                        </li>
                        <li>
                          <span className="text-red-600 font-black text-lg">@viewCount:</span>{" "}
