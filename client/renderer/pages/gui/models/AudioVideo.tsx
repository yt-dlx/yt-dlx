          ...
          <div
            ...
            <ul className="font-semibold list-disc mb-10 text-white text-xl">
              <li
                ...
                className={`hover:text-red-600 text-2xl cursor-pointer italic font-bold ${_quality === "AudioVideoHighest" ? "text-red-600" : "text-white/40"}`}>
              ...
              <li
                ...
                className={`hover:text-red-600 text-2xl cursor-pointer italic font-bold ${_quality === "AudioVideoLowest" ? "text-red-600" : "text-white/40"}`}>
