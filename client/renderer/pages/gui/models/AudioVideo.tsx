    ...
    <motion.div
     ...
     <div
      ...
      <ul className="font-semibold list-disc mb-10 text-white text-xl">
       ...
       <li onClick={() => _quality("AudioVideoLowest")} className={`hover:text-red-600 text-2xl cursor-pointer italic font-bold ${quality === "AudioVideoLowest" ? "text-red-600" : "text-white/40"}`}>
