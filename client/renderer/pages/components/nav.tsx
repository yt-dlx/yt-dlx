...
export default function NavPackage() {
  return (
    <nav className="navbar bg-red-800/10 border-b border-red-600 shadow-red-800/20 shadow-2xl text-white/60 backdrop-blur-lg fixed z-50 top-0 flex justify-between items-center px-6 py-6 font-serif">
      <Link
        href="/home"
