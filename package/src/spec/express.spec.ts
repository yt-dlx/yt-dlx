...
server.get("/api/Account/HomeFeed", async (req: any, res) => {
  try {
    const options = { cookiesPath: req.query.cookiesPath || path.resolve(process.cwd(), "./cookies.txt"), verbose: req.query.verbose, sort: req.query.sort };
...
server.get("/api/Account/SubscriptionsFeed", async (req: any, res) => {
  try {
    const options = { cookiesPath: req.query.cookiesPath || path.resolve(process.cwd(), "./cookies.txt"), verbose: req.query.verbose };
