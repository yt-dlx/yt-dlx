...
async function Video_Tests() {
  ...
  async function VideoHighest() {
    ...
    var emitter = YouTubeDLX.Video.Highest({ query: "test video", output: path.resolve(process.cwd(), "output"), filter: "grayscale", stream: true, verbose: true, metadata: true });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
  }
  async function VideoLowest() {
    ...
    var emitter = YouTubeDLX.Video.Lowest({ query: "test video", output: path.resolve(process.cwd(), "output"), filter: "grayscale", stream: true, verbose: true, metadata: true });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
  }
  await VideoCustom();
...
async function Audio_Tests() {
  async function AudioCustom() {
    ...
    var emitter = YouTubeDLX.Audio.Custom({ query: "test song", resolution: "high", output: path.resolve(process.cwd(), "output") });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
    ...
    var emitter = YouTubeDLX.Audio.Custom({ query: "test song", resolution: "high", output: path.resolve(process.cwd(), "output"), stream: true, filter: "echo", verbose: true, metadata: true });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
  }
  async function AudioHighest() {
    ...
    var emitter = YouTubeDLX.Audio.Highest({ query: "test song", filter: "bassboost", output: path.resolve(process.cwd(), "output") });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
    ...
    var emitter = YouTubeDLX.Audio.Highest({ query: "test song", output: path.resolve(process.cwd(), "output"), filter: "bassboost", stream: true, verbose: true, metadata: true });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
  }
  async function AudioLowest() {
    ...
    var emitter = YouTubeDLX.Audio.Lowest({ query: "test song", filter: "bassboost", output: path.resolve(process.cwd(), "output") });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
    ...
    var emitter = YouTubeDLX.Audio.Lowest({ query: "test song", output: path.resolve(process.cwd(), "output"), filter: "bassboost", stream: true, verbose: true, metadata: true });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
  }
  await AudioCustom();
...
async function Audio_Video_Tests() {
  async function AudioVideoCustom() {
    ...
    var emitter = YouTubeDLX.Audio_Video.Custom({ query: "test song", resolution: "720p", filter: "grayscale", output: path.resolve(process.cwd(), "output") });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
    ...
    var emitter = YouTubeDLX.Audio_Video.Custom({
      query: "test song",
      output: path.resolve(process.cwd(), "output"),
      resolution: "720p",
      filter: "grayscale",
  ...
  async function AudioVideoHighest() {
    ...
    var emitter = YouTubeDLX.Audio_Video.Highest({ query: "test song", filter: "grayscale", output: path.resolve(process.cwd(), "output") });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
    ...
    var emitter = YouTubeDLX.Audio_Video.Highest({ query: "test song", output: path.resolve(process.cwd(), "output"), filter: "grayscale", stream: true, verbose: true, metadata: true });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
  }
  async function AudioVideoLowest() {
    ...
    var emitter = YouTubeDLX.Audio_Video.Lowest({ query: "test song", filter: "grayscale", output: path.resolve(process.cwd(), "output") });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
    ...
    var emitter = YouTubeDLX.Audio_Video.Lowest({ query: "test song", output: path.resolve(process.cwd(), "output"), filter: "grayscale", stream: true, verbose: true, metadata: true });
    emitter.on("data", data => console.log(colors.italic.green("@data:"), data));
    emitter.on("error", error => console.error(colors.italic.red("@error:"), error));
  }
