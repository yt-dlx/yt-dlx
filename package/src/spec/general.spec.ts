...
async function Account_Tests() {
  ...
  async function SubscriptionsFeed() {
    ...
    var emitter = await YouTubeDLX.Account.SubscriptionsFeed({ cookies });
    emitter.on("data", data => console.log(colors.green("@data:"), data));
    emitter.on("error", error => console.error(colors.red("@error:"), error));
    console.log(colors.blue("@info"), "Test For HomeFeed: (2): Fetch subscriptions feed with cookies and verbose output enabled");
    var emitter = await YouTubeDLX.Account.SubscriptionsFeed({ cookies, verbose: true });
    emitter.on("data", data => console.log(colors.green("@data:"), data));
    emitter.on("error", error => console.error(colors.red("@error:"), error));
  }
  async function UnseenNotifications() {
    ...
    var emitter = await YouTubeDLX.Account.Unseen_Notifications({ cookies });
    emitter.on("data", data => console.log(colors.green("@data:"), data));
    emitter.on("error", error => console.error(colors.red("@error:"), error));
    ...
    var emitter = await YouTubeDLX.Account.Unseen_Notifications({ cookies, verbose: true });
    emitter.on("data", data => console.log(colors.green("@data:"), data));
    emitter.on("error", error => console.error(colors.red("@error:"), error));
  }
...
async function Info_Tests() {
  ...
  async function Help() {
    ...
    console.log(colors.green("@data:"), emitter);
  }
...
async function Video_Tests() {
  async function VideoCustom() {
    ...
    emitter.on("stream", streamData => console.log(colors.green("@stream:"), streamData));
    emitter.on("error", error => console.error(colors.red("@error:"), error));
    ...
    emitter.on("metadata", metadata => console.log(colors.green("@metadata:"), metadata));
    emitter.on("error", error => console.error(colors.red("@error:"), error));
