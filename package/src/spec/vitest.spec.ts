...
describe("Account Tests", () => {
  describe("HomeFeed", () => {
    it("should fetch home feed with only cookiesPath", async () => {
      const emitter = YouTubeDLX.Account.HomeFeed({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt") });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch home feed with cookiesPath and verbose", async () => {
      const emitter = YouTubeDLX.Account.HomeFeed({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch home feed with cookiesPath and sort by oldest", async () => {
      const emitter = YouTubeDLX.Account.HomeFeed({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), sort: "oldest" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch home feed with cookiesPath and sort by newest", async () => {
      const emitter = YouTubeDLX.Account.HomeFeed({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), sort: "newest" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch home feed with cookiesPath and sort by old-to-new", async () => {
      const emitter = YouTubeDLX.Account.HomeFeed({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), sort: "old-to-new" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch home feed with cookiesPath and sort by new-to-old", async () => {
      const emitter = YouTubeDLX.Account.HomeFeed({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), sort: "new-to-old" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch home feed with all parameters", async () => {
      const emitter = YouTubeDLX.Account.HomeFeed({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), verbose: true, sort: "new-to-old" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("SubscriptionsFeed", () => {
    it("should fetch subscriptions feed with only cookiesPath", async () => {
      const emitter = YouTubeDLX.Account.SubscriptionsFeed({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt") });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch subscriptions feed with cookiesPath and verbose", async () => {
      const emitter = YouTubeDLX.Account.SubscriptionsFeed({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("UnseenNotifications", () => {
    it("should fetch unseen notifications with only cookiesPath", async () => {
      const emitter = YouTubeDLX.Account.Unseen_Notifications({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt") });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch unseen notifications with cookiesPath and verbose", async () => {
      const emitter = YouTubeDLX.Account.Unseen_Notifications({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("WatchHistory", () => {
    it("should fetch watch history with only cookiesPath", async () => {
      const emitter = YouTubeDLX.Account.History({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt") });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch watch history with cookiesPath and verbose", async () => {
      const emitter = YouTubeDLX.Account.History({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch watch history with cookiesPath and sort by oldest", async () => {
      const emitter = YouTubeDLX.Account.History({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), sort: "oldest" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch watch history with cookiesPath and sort by newest", async () => {
      const emitter = YouTubeDLX.Account.History({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), sort: "newest" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch watch history with cookiesPath and sort by old-to-new", async () => {
      const emitter = YouTubeDLX.Account.History({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), sort: "old-to-new" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch watch history with cookiesPath and sort by new-to-old", async () => {
      const emitter = YouTubeDLX.Account.History({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), sort: "new-to-old" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch watch history with all parameters", async () => {
      const emitter = YouTubeDLX.Account.History({ cookiesPath: path.resolve(process.cwd(), "./cookies.txt"), verbose: true, sort: "new-to-old" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
...
describe("Search Tests", () => {
  describe("AdvanceSearch", () => {
    it("should perform basic search with only query", async () => {
      const emitter = YouTubeDLX.Search.Video.Advance_Search({ query: "Node.js tutorial" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should search with minimum view count", async () => {
      const emitter = YouTubeDLX.Search.Video.Advance_Search({ query: "Node.js tutorial", minViews: 1000 });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should search with maximum view count", async () => {
      const emitter = YouTubeDLX.Search.Video.Advance_Search({ query: "Node.js tutorial", maxViews: 200000 });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should search with both minViews and maxViews", async () => {
      const emitter = YouTubeDLX.Search.Video.Advance_Search({ query: "Node.js tutorial", minViews: 500, maxViews: 50000 });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should search with ordering by view count", async () => {
      const emitter = YouTubeDLX.Search.Video.Advance_Search({ query: "Node.js tutorial", orderBy: "viewCount" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should search with verbose output", async () => {
      const emitter = YouTubeDLX.Search.Video.Advance_Search({ query: "Node.js tutorial", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should search with order by date", async () => {
      const emitter = YouTubeDLX.Search.Video.Advance_Search({ query: "Node.js tutorial", orderBy: "date" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    ...
    it("should search with all parameters", async () => {
      const emitter = YouTubeDLX.Search.Video.Advance_Search({ query: "Node.js tutorial", minViews: 1000, maxViews: 200000, orderBy: "viewCount", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("ChannelData", () => {
    it("should fetch channel data with channel link", async () => {
      const emitter = YouTubeDLX.Search.Video.Channel_Data({ channelLink: "https://www.youtube.com/c/Techquickie" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("PlaylistData", () => {
    it("should fetch playlist data with valid playlist link", async () => {
      const emitter = YouTubeDLX.Search.Playlist.Single({ playlistLink: "https://www.youtube.com/playlist?list=PLw-VjHDlEOgs6k8xQ6sB9zAqS6vhJh2tV" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should handle invalid playlist link", async () => {
      const emitter = YouTubeDLX.Search.Playlist.Single({ playlistLink: "https://www.youtube.com/playlist?list=INVALID" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => reject(new Error("Expected error, but got data")));
        emitter.on("error", () => resolve());
      });
    }, 20000);
  });
  describe("RelatedVideos", () => {
    it("should fetch related videos with valid video ID", async () => {
      const emitter = YouTubeDLX.Search.Video.Related({ videoId: "dQw4w9WgXcQ" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    ...
    it("should handle invalid video ID", async () => {
      const emitter = YouTubeDLX.Search.Video.Related({ videoId: "INVALID_VIDEO_ID" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => reject(new Error("Expected error, but got data")));
        emitter.on("error", () => resolve());
      });
  ...
  describe("SearchChannels", () => {
    it("should search channels with valid query", async () => {
      const emitter = YouTubeDLX.Search.Video.Channel({ query: "Tech channels" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should handle invalid channel query", async () => {
      const emitter = YouTubeDLX.Search.Video.Channel({ query: "INVALID_QUERY" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("SearchPlaylists", () => {
    it("should search playlists with valid query", async () => {
      const emitter = YouTubeDLX.Search.Playlist.Multiple({ playlistLink: "Top 10 Music Playlists" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    ...
    it("should handle invalid playlist link", async () => {
      const emitter = YouTubeDLX.Search.Playlist.Multiple({ playlistLink: "INVALID_PLAYLIST_LINK" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => reject(new Error("Expected error, but got data")));
        emitter.on("error", () => resolve());
      });
    }, 20000);
    it("should search playlists with valid playlist ID", async () => {
      const emitter = YouTubeDLX.Search.Playlist.Multiple({ playlistLink: "https://www.youtube.com/playlist?list=PLw-VjHDlEOgs6k8xQ6sB9zAqS6vhJh2tV" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("SearchVideos", () => {
    it("should search videos with valid query", async () => {
      const emitter = YouTubeDLX.Search.Video.Multiple({ query: "Node.js tutorial" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should handle invalid video query", async () => {
      const emitter = YouTubeDLX.Search.Video.Multiple({ query: "INVALID_QUERY" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should handle video link as query", async () => {
      const emitter = YouTubeDLX.Search.Video.Multiple({ query: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("VideoData", () => {
    it("should fetch video data with valid video link", async () => {
      const emitter = YouTubeDLX.Search.Video.Single({ videoLink: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should handle invalid video link", async () => {
      const emitter = YouTubeDLX.Search.Video.Single({ videoLink: "https://www.youtube.com/watch?v=INVALID_ID" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => reject(new Error("Expected error, but got data")));
        emitter.on("error", () => resolve());
      });
...
describe("Info Tests", () => {
  describe("Extract", () => {
    it("should extract video data with only query", async () => {
      const emitter = YouTubeDLX.Info.Extract({ query: "Node.js tutorial" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should extract video data with verbose", async () => {
      const emitter = YouTubeDLX.Info.Extract({ query: "Node.js tutorial", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should extract video data with Tor", async () => {
      const emitter = YouTubeDLX.Info.Extract({ query: "Node.js tutorial", useTor: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should extract video data with all parameters", async () => {
      const emitter = YouTubeDLX.Info.Extract({ query: "Node.js tutorial", verbose: true, useTor: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("Help", () => {
    it("should display help message and get the help URL", async () => {
      const helpUrl = await YouTubeDLX.Info.Help();
      expect(helpUrl).toBeDefined();
      expect(typeof helpUrl).toBe("string");
    }, 20000);
  });
  describe("ListFormats", () => {
    it("should list formats with only query", async () => {
      const emitter = YouTubeDLX.Info.Formats({ query: "Node.js tutorial" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should list formats with query and verbose", async () => {
      const emitter = YouTubeDLX.Info.Formats({ query: "Node.js tutorial", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("LiveVideoData", () => {
    it("should fetch live video data with only video link", async () => {
      const emitter = YouTubeDLX.Info.Live({ videoLink: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch live video data with verbose", async () => {
      const emitter = YouTubeDLX.Info.Live({ videoLink: "https://www.youtube.com/watch?v=dQw4w9WgXcQ", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("VideoComments", () => {
    it("should fetch video comments with only query", async () => {
      const emitter = YouTubeDLX.Info.Comments({ query: "Node.js tutorial" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch video comments with verbose", async () => {
      const emitter = YouTubeDLX.Info.Comments({ query: "Node.js tutorial", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch video comments with filter newest", async () => {
      const emitter = YouTubeDLX.Info.Comments({ query: "Node.js tutorial", filter: "newest" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch video comments with filter most_liked", async () => {
      const emitter = YouTubeDLX.Info.Comments({ query: "Node.js tutorial", filter: "most_liked" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch video comments with filter pinned", async () => {
      const emitter = YouTubeDLX.Info.Comments({ query: "Node.js tutorial", filter: "pinned" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch video comments with filter longest", async () => {
      const emitter = YouTubeDLX.Info.Comments({ query: "Node.js tutorial", filter: "longest" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("VideoTranscript", () => {
    it("should fetch transcript with valid video link", async () => {
      const emitter = YouTubeDLX.Info.Transcript({ videoLink: "https://www.youtube.com/watch?v=dQw4w9WgXcQ" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should handle invalid video link for transcript", async () => {
      const emitter = YouTubeDLX.Info.Transcript({ videoLink: "https://www.youtube.com/watch?v=INVALID_ID" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => reject(new Error("Expected error, but got data")));
        emitter.on("error", () => resolve());
      });
...
describe("Video Tests", () => {
  describe("VideoCustom", () => {
    it("should process video with query and resolution", async () => {
      const emitter = YouTubeDLX.Video.Custom({ query: "Node.js tutorial", resolution: "720p" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process video with query, resolution, and filter", async () => {
      const emitter = YouTubeDLX.Video.Custom({ query: "Node.js tutorial", resolution: "1080p", filter: "grayscale" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should stream video with query, resolution, and stream", async () => {
      const emitter = YouTubeDLX.Video.Custom({ query: "Node.js tutorial", resolution: "480p", stream: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("stream", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process video with verbose", async () => {
      const emitter = YouTubeDLX.Video.Custom({ query: "Node.js tutorial", resolution: "720p", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch metadata with query and resolution", async () => {
      const emitter = YouTubeDLX.Video.Custom({ query: "Node.js tutorial", resolution: "1080p", metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("metadata", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process video with query, resolution, filter, stream, and metadata", async () => {
      const emitter = YouTubeDLX.Video.Custom({ query: "Node.js tutorial", resolution: "720p", filter: "grayscale", stream: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process video with all parameters", async () => {
      const emitter = YouTubeDLX.Video.Custom({
  ...
  describe("VideoHighest", () => {
    it("should process highest quality video with query", async () => {
      const emitter = YouTubeDLX.Video.Highest({ query: "Node.js tutorial" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality video with filter", async () => {
      const emitter = YouTubeDLX.Video.Highest({ query: "Node.js tutorial", filter: "grayscale" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should stream highest quality video", async () => {
      const emitter = YouTubeDLX.Video.Highest({ query: "Node.js tutorial", stream: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("stream", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality video with verbose", async () => {
      const emitter = YouTubeDLX.Video.Highest({ query: "Node.js tutorial", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch metadata for highest quality video", async () => {
      const emitter = YouTubeDLX.Video.Highest({ query: "Node.js tutorial", metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("metadata", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality video with filter, stream, and metadata", async () => {
      const emitter = YouTubeDLX.Video.Highest({ query: "Node.js tutorial", filter: "grayscale", stream: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality video with all parameters", async () => {
      const emitter = YouTubeDLX.Video.Highest({ query: "Node.js tutorial", output: path.resolve(process.cwd(), "./output"), filter: "grayscale", stream: true, verbose: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("VideoLowest", () => {
    it("should process lowest quality video with query", async () => {
      const emitter = YouTubeDLX.Video.Lowest({ query: "Node.js tutorial" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality video with filter", async () => {
      const emitter = YouTubeDLX.Video.Lowest({ query: "Node.js tutorial", filter: "grayscale" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should stream lowest quality video", async () => {
      const emitter = YouTubeDLX.Video.Lowest({ query: "Node.js tutorial", stream: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("stream", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality video with verbose", async () => {
      const emitter = YouTubeDLX.Video.Lowest({ query: "Node.js tutorial", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch metadata for lowest quality video", async () => {
      const emitter = YouTubeDLX.Video.Lowest({ query: "Node.js tutorial", metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("metadata", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality video with filter, stream, and metadata", async () => {
      const emitter = YouTubeDLX.Video.Lowest({ query: "Node.js tutorial", filter: "grayscale", stream: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality video with all parameters", async () => {
      const emitter = YouTubeDLX.Video.Lowest({ query: "Node.js tutorial", output: path.resolve(process.cwd(), "./output"), filter: "grayscale", stream: true, verbose: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
...
describe("Audio Tests", () => {
  describe("AudioCustom", () => {
    it("should process audio with query and resolution", async () => {
      const emitter = YouTubeDLX.Audio.Custom({ query: "lofi beats", resolution: "high" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process audio with verbose", async () => {
      const emitter = YouTubeDLX.Audio.Custom({ query: "lofi beats", resolution: "high", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process audio with custom output", async () => {
      const emitter = YouTubeDLX.Audio.Custom({ query: "lofi beats", resolution: "high", output: path.resolve(process.cwd(), "./output") });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should stream audio", async () => {
      const emitter = YouTubeDLX.Audio.Custom({ query: "lofi beats", resolution: "high", stream: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("stream", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process audio with filter", async () => {
      const emitter = YouTubeDLX.Audio.Custom({ query: "lofi beats", resolution: "high", filter: "bassboost" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch audio metadata", async () => {
      const emitter = YouTubeDLX.Audio.Custom({ query: "lofi beats", resolution: "high", metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("metadata", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process audio with all parameters", async () => {
      const emitter = YouTubeDLX.Audio.Custom({
        query: "lofi beats",
        resolution: "high",
        output: path.resolve(process.cwd(), "./output"),
        stream: true,
  ...
  describe("AudioHighest", () => {
    it("should process highest quality audio with query and filter", async () => {
      const emitter = YouTubeDLX.Audio.Highest({ query: "lofi beats", filter: "bassboost" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality audio with verbose", async () => {
      const emitter = YouTubeDLX.Audio.Highest({ query: "lofi beats", filter: "bassboost", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality audio with custom output", async () => {
      const emitter = YouTubeDLX.Audio.Highest({ query: "lofi beats", filter: "bassboost", output: path.resolve(process.cwd(), "./output") });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should stream highest quality audio", async () => {
      const emitter = YouTubeDLX.Audio.Highest({ query: "lofi beats", stream: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("stream", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch metadata for highest quality audio", async () => {
      const emitter = YouTubeDLX.Audio.Highest({ query: "lofi beats", filter: "bassboost", metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("metadata", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality audio with filter, stream, and metadata", async () => {
      const emitter = YouTubeDLX.Audio.Highest({ query: "lofi beats", filter: "bassboost", stream: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality audio with all parameters", async () => {
      const emitter = YouTubeDLX.Audio.Highest({ query: "lofi beats", output: path.resolve(process.cwd(), "./output"), filter: "bassboost", stream: true, verbose: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("AudioLowest", () => {
    it("should process lowest quality audio with query and filter", async () => {
      const emitter = YouTubeDLX.Audio.Lowest({ query: "lofi beats", filter: "bassboost" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality audio with verbose", async () => {
      const emitter = YouTubeDLX.Audio.Lowest({ query: "lofi beats", filter: "bassboost", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality audio with custom output", async () => {
      const emitter = YouTubeDLX.Audio.Lowest({ query: "lofi beats", filter: "bassboost", output: path.resolve(process.cwd(), "./output") });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should stream lowest quality audio", async () => {
      const emitter = YouTubeDLX.Audio.Lowest({ query: "lofi beats", stream: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("stream", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch metadata for lowest quality audio", async () => {
      const emitter = YouTubeDLX.Audio.Lowest({ query: "lofi beats", filter: "bassboost", metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("metadata", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality audio with filter, stream, and metadata", async () => {
      const emitter = YouTubeDLX.Audio.Lowest({ query: "lofi beats", filter: "bassboost", stream: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality audio with all parameters", async () => {
      const emitter = YouTubeDLX.Audio.Lowest({ query: "lofi beats", output: path.resolve(process.cwd(), "./output"), filter: "bassboost", stream: true, verbose: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
...
describe("Audio_Video Tests", () => {
  describe("AudioVideoCustom", () => {
    it("should process audio and video with query, resolution, and filter", async () => {
      const emitter = YouTubeDLX.Audio_Video.Custom({ query: "lofi beats", resolution: "720p", filter: "grayscale" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process audio and video with verbose", async () => {
      const emitter = YouTubeDLX.Audio_Video.Custom({ query: "lofi beats", resolution: "720p", filter: "grayscale", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process audio and video with custom output", async () => {
      const emitter = YouTubeDLX.Audio_Video.Custom({ query: "lofi beats", resolution: "720p", filter: "grayscale", output: path.resolve(process.cwd(), "./output") });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should stream audio and video", async () => {
      const emitter = YouTubeDLX.Audio_Video.Custom({ query: "lofi beats", resolution: "720p", stream: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("stream", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch metadata for audio and video", async () => {
      const emitter = YouTubeDLX.Audio_Video.Custom({ query: "lofi beats", resolution: "720p", filter: "grayscale", metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("metadata", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process audio and video with filter, stream, and metadata", async () => {
      const emitter = YouTubeDLX.Audio_Video.Custom({ query: "lofi beats", resolution: "720p", filter: "grayscale", stream: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process audio and video with all parameters", async () => {
      const emitter = YouTubeDLX.Audio_Video.Custom({
        query: "lofi beats",
        output: path.resolve(process.cwd(), "./output"),
        resolution: "720p",
        filter: "grayscale",
  ...
  describe("AudioVideoHighest", () => {
    it("should process highest quality audio and video with query and filter", async () => {
      const emitter = YouTubeDLX.Audio_Video.Highest({ query: "lofi beats", filter: "grayscale" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality audio and video with verbose", async () => {
      const emitter = YouTubeDLX.Audio_Video.Highest({ query: "lofi beats", filter: "grayscale", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality audio and video with custom output", async () => {
      const emitter = YouTubeDLX.Audio_Video.Highest({ query: "lofi beats", filter: "grayscale", output: path.resolve(process.cwd(), "./output") });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should stream highest quality audio and video", async () => {
      const emitter = YouTubeDLX.Audio_Video.Highest({ query: "lofi beats", filter: "grayscale", stream: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("stream", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch metadata for highest quality audio and video", async () => {
      const emitter = YouTubeDLX.Audio_Video.Highest({ query: "lofi beats", filter: "grayscale", metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("metadata", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality audio and video with filter, stream, and metadata", async () => {
      const emitter = YouTubeDLX.Audio_Video.Highest({ query: "lofi beats", filter: "grayscale", stream: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process highest quality audio and video with all parameters", async () => {
      const emitter = YouTubeDLX.Audio_Video.Highest({ query: "lofi beats", output: path.resolve(process.cwd(), "./output"), filter: "grayscale", stream: true, verbose: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
  ...
  describe("AudioVideoLowest", () => {
    it("should process lowest quality audio and video with query and filter", async () => {
      const emitter = YouTubeDLX.Audio_Video.Lowest({ query: "lofi beats", filter: "grayscale" });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality audio and video with verbose", async () => {
      const emitter = YouTubeDLX.Audio_Video.Lowest({ query: "lofi beats", filter: "grayscale", verbose: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality audio and video with custom output", async () => {
      const emitter = YouTubeDLX.Audio_Video.Lowest({ query: "lofi beats", filter: "grayscale", output: path.resolve(process.cwd(), "./output") });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should stream lowest quality audio and video", async () => {
      const emitter = YouTubeDLX.Audio_Video.Lowest({ query: "lofi beats", filter: "grayscale", stream: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("stream", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should fetch metadata for lowest quality audio and video", async () => {
      const emitter = YouTubeDLX.Audio_Video.Lowest({ query: "lofi beats", filter: "grayscale", metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("metadata", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality audio and video with filter, stream, and metadata", async () => {
      const emitter = YouTubeDLX.Audio_Video.Lowest({ query: "lofi beats", filter: "grayscale", stream: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
    }, 20000);
    it("should process lowest quality audio and video with all parameters", async () => {
      const emitter = YouTubeDLX.Audio_Video.Lowest({ query: "lofi beats", output: path.resolve(process.cwd(), "./output"), filter: "grayscale", stream: true, verbose: true, metadata: true });
      await new Promise<void>((resolve, reject) => {
        emitter.on("data", () => resolve());
        emitter.on("error", reject);
      });
