 ...
 *
 * @example
 * // 1: Process the highest quality video with only the query and resolution
 ...
 *
 * @example
 * // 2: Process the highest quality video with the query, resolution, and a filter (grayscale)
 ...
 *
 * @example
 * // 3: Stream the highest quality video with the query, resolution, and stream option enabled
 ...
 *
 * @example
 * // 4: Process the highest quality video with verbose output enabled
