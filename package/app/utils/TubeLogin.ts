 ...
 */
export let Tubed: Innertube | null = null;
/**
 ...
 * @async
 * @function TubeLogin
 * @returns {Promise<Innertube>} The authenticated Innertube client.
 */
export default async function TubeLogin(): Promise<Innertube> {
