 ...
 *
 * @typedef {object} VideoCustomOptions
 ...
 * @param {VideoCustomOptions} options - The options object containing query and settings.
 * @returns {EventEmitter} The event emitter to handle progress, error, start, end, and stream events.
 *
 * @example
 * const emitter = VideoCustom({ query: "Funny Video", resolution: "1080p", filter: "grayscale", stream: true });
