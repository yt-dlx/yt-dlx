              ...
              <motion.div className="overflow-x-auto" {...AndBounce}>
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        <Link href="/docs/Audio/AudioCustom" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> AudioOnly.Single.Custom()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Audio/AudioHighest" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> AudioOnly.Single.Highest()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Audio/AudioLowest" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> AudioOnly.Single.Lowest()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Video/VideoCustom" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> VideoOnly.Single.Custom()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Video/VideoHighest" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> VideoOnly.Single.Highest()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Video/VideoLowest" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> VideoOnly.Single.Lowest()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/AudioVideo/AudioVideoCustom" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> AudioVideo.Single.Custom()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/AudioVideo/AudioVideoHighest" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> AudioVideo.Single.Highest()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/AudioVideo/AudioVideoLowest" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> AudioVideo.Single.Lowest()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Command/extract" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> info.extract()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Command/list_formats" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> info.list_formats()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Command/playlist_data" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> ytSearch.Playlist.Single()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Command/search_playlist" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> ytSearch.Playlist.Multiple()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Command/search_videos" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> ytSearch.Video.Multiple()
                        </Link>
                      </td>
                    ...
                    <tr>
                      <td>
                        <Link href="/docs/Command/video_data" className="font-bold flex items-center justify-center gap-2 hover:text-red-700">
                          <FaClipboardCheck className="mr-2 inline-block h-4 w-4 text-red-700" /> ytSearch.Video.Single()
                        </Link>
                      </td>
