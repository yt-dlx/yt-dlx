export default function FootPackage() {
  return (
    <footer id="Footer" className="pt-20 pb-6 flex flex-wrap items-baseline justify-center">
      ...
      <span className="mt-2 text-sm font-light text-[#C4C4C4]">Copyright © 2024</span>
    </footer>
  );
}
