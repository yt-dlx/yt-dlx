                ...
                <div className="mt-8 grid grid-cols-1 gap-8 md:mt-16 bg-stone-950 border-4 border-red-600 border-double rounded-3xl shadow-red-600 duration-500 shadow-[0_0_20px_rgba(255,0,0,0.5)]">
                  <div className="overflow-x-auto">
                    <section className="max-w-screen-2xl px-6 mx-auto p-1">
                      ...
                      />
                      <h2 className="mt-6 text-4xl font-bold text-red-600">{TubeSearch.title}</h2>
                      ...
                      <p className="mt-6 text-xs text-red-600 items-center justify-center flex font-bold">
                        Effortless Audio-Video Downloading And Streaming Is Provided Free Of Cost To
                        You With The Power Of Yt-Dlx Copyright © 2024
                      </p>
                      ...
                      <ul className="mt-2 text-white/60 list-disc p-6">
                        <li>
                          <span className="text-red-600 font-bold">@videoId:</span> {TubeSearch.id}
                        </li>
                        <li>
                          <span className="text-red-600 font-bold">@channelid:</span>{" "}
                          {TubeSearch.channelid}
                        </li>
                        <li>
                          <span className="text-red-600 font-bold">@channelname:</span>{" "}
                        ...
                        <li>
                          <span className="text-red-600 font-bold">@uploadDate:</span>{" "}
                          {TubeSearch.uploadDate}
                        </li>
                        <li>
                          <span className="text-red-600 font-bold">@viewCount:</span>{" "}
