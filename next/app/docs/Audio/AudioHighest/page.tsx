        ...
        <div className="max-w-screen-2xl px-6 py-16 mx-auto space-y-12">
          <article className="space-y-8">
            ...
            <p className="text-white/60">
              Uncover an unparalleled solution for
              effortless audio and video downloads powered
              by YT-DLX - An advanced{" "}
              <span className="text-red-600">
                (command-line + Node.js + Streaming)
              </span>{" "}
              tool meticulously designed for avid
              enthusiasts. YT-DLX stands out as a
              feature-rich advanced package built upon the
              foundation of{" "}
              <span className="text-red-600">
          ...
          <div>
            ...
            <div className="space-y-2 pt-8">
              <p className="text-2xl font-semibold text-red-600">
                Install now using any package manager of
                your choice!
              </p>
        ...
        <div className="max-w-screen-4xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="max-w-screen-2xl">
            ...
            <p className="mt-4 text-white/60">
              yt-dlx accommodates various node.js coding
              flavours!{" "}
              <span className="text-red-600">
                (typescript), (commonjs),
              </span>{" "}
              and{" "}
              <span className="text-red-600">(esm)</span>,
              ensuring 100% compatibility and comprehensive
            ...
            <ul className="list-disc m-4 bg-neutral-800/40 shadow-black shadow-2xl p-8 rounded-3xl border border-dashed border-red-600">
              ...
              <li>
                @param stream - (optional) Whether to stream
                the processed video or not.
              </li>
              <li>
              ...
              <li>
                @param filter - (optional) The audio filter
                to apply. Available options: echo, slow,
                speed, phaser, flanger, panning, reverse,
                vibrato, subboost, surround, bassboost,
                nightcore, superslow, vaporwave, superspeed.
              </li>
              <li>
                @param onionTor - (optional) Whether to use
                Tor for the download or not.
              </li>
              <li>
                @returns A Promise that resolves with either
                `void` (if `stream` is false) or an object
                containing the `ffmpeg` instance and the
                ...
                <div className="w-full max-w-lg mx-auto my-4 bg-neutral-900 rounded-2xl border-red-600 border shadow-red-600 shadow-[0_0_20px_rgba(255,0,0,0.5)]">
                  ...
                  <div className="p-6 lg:text-center">
                    ...
                    <p className="mt-3 text-base leading-relaxed text-white/60">
                      ...
                      compiles down to plain JavaScript and
                      is widely adopted for large-scale
                ...
                <div className="w-full max-w-lg mx-auto my-4 bg-neutral-900 rounded-2xl border-red-600 border shadow-red-600 shadow-[0_0_20px_rgba(255,0,0,0.5)]">
                  ...
                  <div className="p-6 lg:text-center">
                    ...
                    <p className="mt-3 text-base leading-relaxed text-white/60">
                      ...
                      interactive content on websites. It's
                      supported by all modern web browsers
                      and can be used for both front-end and
                ...
                <div className="w-full max-w-lg mx-auto my-4 bg-neutral-900 rounded-2xl border-red-600 border shadow-red-600 shadow-[0_0_20px_rgba(255,0,0,0.5)]">
                  ...
                  <div className="p-6 lg:text-center">
                    ...
                    <p className="mt-3 text-base leading-relaxed text-white/60">
                      ...
                      popular implementation of ECMAScript,
                      and new versions are regularly
                      released to add features and improve
                      the language.
                      <br />
                      <span className="font-black text-red-600 text-xl">
                        import ytdlx from "yt-dlx";
