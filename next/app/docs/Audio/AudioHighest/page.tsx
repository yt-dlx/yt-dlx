        ...
        <div className="max-w-screen-2xl px-6 py-16 mx-auto space-y-12">
          <article className="space-y-8">
            ...
            <p className="text-white/60">
              Uncover an unparalleled solution for effortless audio and video downloads powered by
              YT-DLX - An advanced{" "}
              <span className="text-red-600">(command-line + Node.js + Streaming)</span> tool
              meticulously designed for avid enthusiasts. YT-DLX stands out as a feature-rich
              advanced package built upon the foundation of{" "}
              <span className="text-red-600">(Youtube-DL & Python yt-dlx)</span>, consistently
              evolving with state-of-the-art functionalities.
            </p>
          </article>
          <div>
        ...
        <div className="max-w-screen-4xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          <div className="max-w-screen-2xl">
            ...
            <p className="mt-4 text-white/60">
              ...
              <span className="text-red-600">(typescript), (commonjs),</span> and{" "}
              <span className="text-red-600">(esm)</span>, ensuring 100% compatibility and
            ...
            <ul className="list-disc m-4 bg-neutral-800/40 shadow-black shadow-2xl p-8 rounded-3xl border border-dashed border-red-600">
              ...
              <li>@param output - (optional) The output directory for the processed file.</li>
              <li>@param stream - (optional) Whether to stream the processed video or not.</li>
              <li>@param verbose - (optional) Whether to log verbose output or not.</li>
              <li>
                @param filter - (optional) The audio filter to apply. Available options: echo, slow,
                speed, phaser, flanger, panning, reverse, vibrato, subboost, surround, bassboost,
                nightcore, superslow, vaporwave, superspeed.
              </li>
              <li>@param onionTor - (optional) Whether to use Tor for the download or not.</li>
              <li>
                @returns A Promise that resolves with either `void` (if `stream` is false) or an
                object containing the `ffmpeg` instance and the output filename (if `stream` is
                true).
              </li>
            </ul>
              ...
              <div className="flex flex-col md:flex-row lg:flex-row xl:flex-row gap-4">
                <div className="w-full max-w-lg mx-auto my-4 bg-neutral-900 rounded-2xl border-red-600 border shadow-red-600 shadow-[0_0_20px_rgba(255,0,0,0.5)]">
                  ...
                  <div className="p-6 lg:text-center">
                    ...
                    <p className="mt-3 text-base leading-relaxed text-white/60">
                      A superset of JavaScript that adds optional static typing and other features
                      to enhance code maintainability and scalability. It compiles down to plain
                      JavaScript and is widely adopted for large-scale applications due to its
                    ...
                    <div className="mt-6">
                      <a
                        href="https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/typescript/Audio/single.highest.test.ts"
                ...
                <div className="w-full max-w-lg mx-auto my-4 bg-neutral-900 rounded-2xl border-red-600 border shadow-red-600 shadow-[0_0_20px_rgba(255,0,0,0.5)]">
                  ...
                  <div className="p-6 lg:text-center">
                    ...
                    <p className="mt-3 text-base leading-relaxed text-white/60">
                      A versatile, high-level programming language primarily used for web
                      development, enabling dynamic and interactive content on websites. It's
                      supported by all modern web browsers and can be used for both front-end and
                    ...
                    <div className="mt-6">
                      <a
                        href="https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/javascript/Audio/single.highest.test.js"
                        className="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-red-900 rounded-xl hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                        View profile
                      </a>
                    </div>
                ...
                <div className="w-full max-w-lg mx-auto my-4 bg-neutral-900 rounded-2xl border-red-600 border shadow-red-600 shadow-[0_0_20px_rgba(255,0,0,0.5)]">
                  ...
                  <div className="p-6 lg:text-center">
                    ...
                    <p className="mt-3 text-base leading-relaxed text-white/60">
                      The standardized specification for JavaScript, defining the syntax, semantics,
                      and behavior of the language. JavaScript is the most popular implementation of
                      ECMAScript, and new versions are regularly released to add features and
                    ...
                    <div className="mt-6">
                      <a
                        href="https://github.com/yt-dlx/yt-dlx/blob/main/config/examples/ecmascript/Audio/single.highest.test.mjs"
                        className="flex items-center justify-center w-full px-10 py-4 text-base font-medium text-center text-white transition duration-500 ease-in-out transform bg-red-900 rounded-xl hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
                        View profile
                      </a>
                    </div>
