...
export default function home() {
  ...
  return (
    <main className="overflow-x-hidden max-h-screen scrollbar-thin bg-[#111111] scrollbar-track-[#111111] scrollbar-thumb-red-600">
      ...
      {/* ================================[ Introduction ]============================== */}
      <react.Fragment>
        <section id="Introduction" className="flex flex-col items-center justify-center mt-20">
          <div className="max-w-screen-2xl px-6 py-16 mx-auto space-y-12">
            <article className="space-y-8">
              <VerPackage />
              <p className="text-white/60">
                Yt-Dlx Is A Robust Multimedia Downloading Tool Meticulously Crafted To Elevate Your
                Media Consumption Experience. With Its Advanced Capabilities, It Offers An
                All-Encompassing Solution For Effortlessly Acquiring Audio And Video Content From
                Diverse Sources. Drawing Inspiration From Renowned Projects Such As Python-Yt-Dlp
                And Python-Youtube-Dl, Yt-Dlx Combines Cutting-Edge Features With Real-Time Data
                Acquisition Facilitated By Puppeteer Technologies. Whether You Seek To Enrich Your
                Audio Library Or Curate A Collection Of High-Quality Videos, Yt-Dlx Stands As Your
      ...
      {/* =================================[ Playground ]=============================== */}
      <react.Fragment>
        <section id="Playground" className="flex flex-col items-center justify-center">
          <form
            onSubmit={event => {
            ...
            <p className="mb-8 italic text-white/60">
              Unlock the power of YT-DLX, the ultimate node.js toolkit for seamless audio and video
              downloading and streaming. Effortlessly handle various coding flavors, from TypeScript
              ...
              <label className="form-control w-full">
                <div className="label">
                  <span className="flex flex-row items-center justify-center label-text text-red-600 text-sm">
                    ...
                    option :<span className="text-white/60">provide video name</span>
                  </span>
                  <span className="flex flex-row items-center justify-center label-text-alt text-red-600 text-sm">
                    <HiFire size={20} className="text-red-600 animate-pulse" />
                    option :<span className="text-white/60">provide video link</span>
                  </span>
                </div>
                <input
                  type="text"
                ...
                <div className="label">
                  <span className="flex flex-row items-center justify-center label-text-alt text-red-600 text-sm">
                    <HiFire size={20} className="text-red-600 animate-pulse" />
                    option :<span className="text-white/60">provide video id</span>
                  </span>
                </div>
              </label>
            </div>
...
<code>start typing to get suggestions...</code>
                            ...
                            <div className="flex-1 flex flex-col">
                              ...
                              <div className="flex items-center text-white/60">
                                <ul className="mb-3 list-disc ml-4 text-xs">
                                  <li>
                                    <span className="text-red-600 text-sm">videoId:</span> {item.id}
                                  </li>
                                  <li>
                                    <span className="text-red-600 text-sm">channelid:</span>{" "}
                                    {item.channelid}
                                  </li>
                                  <li>
                                    <span className="text-red-600 text-sm">channelname:</span>{" "}
                                    {item.channelname}
                                  </li>
                                  <li>
                                    <span className="text-red-600 text-sm">duration:</span>{" "}
                                    {item.duration}
                                  </li>
                                  <li>
                                    <span className="text-red-600 text-sm">uploadDate:</span>{" "}
                                    {item.uploadDate}
                                  </li>
                                  <li>
                                    <span className="text-red-600 text-sm">viewCount:</span>{" "}
                                    {item.viewCount}
                                  </li>
                                </ul>
                              </div>
      ...
      {/* ================================[ Documentation ]============================== */}
      <react.Fragment>
        <section id="Documentation" className="flex flex-col items-center justify-center">
          <div className="px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
            ...
            <p className="mt-4 text-white/60">
              ...
              <span className="text-red-600">(typescript), (commonjs) and (esm)</span>, ensuring
              ...
              <div className="overflow-x-auto">
                ...
                <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical p-2 border-b-4 border-red-600 shadow-[0_0_20px_rgba(255,0,0,0.5)] shadow-red-600">
                  <li>
                    ...
                    <div className="timeline-start md:text-end mb-10">
                      <time className="font-mono italic font-bold text-red-600">Audio Only</time>
                      <div className="text-lg font-black">Audio.Single.Highest</div>
                  ...
                  <li>
                    ...
                    <div className="timeline-end mb-10">
                      <time className="font-mono italic font-bold text-red-600">Audio Only</time>
                      <div className="text-lg font-black">Audio.Single.Lowest</div>
                  ...
                  <li>
                    ...
                    <div className="timeline-start md:text-end mb-10">
                      <time className="font-mono italic font-bold text-red-600">Audio Only</time>
                      <div className="text-lg font-black">Audio.Single.Custom</div>
                ...
                <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical p-2 border-b-4 border-red-600 shadow-[0_0_20px_rgba(255,0,0,0.5)] shadow-red-600">
                  <li>
                    ...
                    <div className="timeline-start md:text-end mb-10">
                      <time className="font-mono italic font-bold text-red-600">Video Only</time>
                      <div className="text-lg font-black">Video.Single.Highest</div>
                      Downloads the highest quality version of a YouTube video with customization
                      options.
                      <br />
                      <Link
                  ...
                  <li>
                    ...
                    <div className="timeline-end mb-10">
                      <time className="font-mono italic font-bold text-red-600">Video Only</time>
                      <div className="text-lg font-black">Video.Single.Lowest</div>
                      Downloads the lowest quality version of a YouTube video with customization
                      options.
                      <br />
                      <Link
                  ...
                  <li>
                    ...
                    <div className="timeline-start md:text-end mb-10">
                      <time className="font-mono italic font-bold text-red-600">Video Only</time>
                      <div className="text-lg font-black">Video.Single.Custom</div>
                ...
                <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical p-2 border-b-4 border-red-600 shadow-[0_0_20px_rgba(255,0,0,0.5)] shadow-red-600">
                  <li>
                    <div className="timeline-middle bg-stone-800 p-2 rounded-2xl">
                      <AiFillCodeSandboxCircle className="text-red-600" size={30} />
                    </div>
                    <div className="timeline-start md:text-end mb-10">
                      <time className="font-mono italic font-bold text-red-600">
                        Audio with Video
                      </time>
                      <div className="text-lg font-black">AudioVideo.Single.Highest</div>
                      Downloads audio and video from a YouTube video URL with the highest available
                      resolution.
                      <br />
                      <Link
                  ...
                  <li>
                    ...
                    <div className="timeline-end mb-10">
                      ...
                      <div className="text-lg font-black">AudioVideo.Single.Lowest</div>
                  ...
                  <li>
                    ...
                    <div className="timeline-start md:text-end mb-10">
                      ...
                      <div className="text-lg font-black">AudioVideo.Single.Custom</div>
                ...
                <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical p-2 border-b-4 border-red-600 shadow-[0_0_20px_rgba(255,0,0,0.5)] shadow-red-600">
                  <li>
                    ...
                    <div className="timeline-start md:text-end mb-10">
                      <time className="font-mono italic font-bold text-red-600">Info Gatherer</time>
