...
const code = {
  ...
  "update:base": "yarn upgrade --latest --silent",
  "update:client": "cd client && yarn upgrade --latest --silent",
  update:
    "yarn run update:base && yarn run update:next && yarn run update:client",
  "update:next":
    "cd next && yarn upgrade --latest --silent && yarn remove sharp && yarn add sharp@0.32.6",
