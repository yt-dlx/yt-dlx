          ...
          <div className="relative items-center w-full px-5 py-12 mx-auto md:px-12 lg:px-16 lg:py-24">
            <div className="flex w-full mx-auto text-left">
              <div className="relative inline-flex items-center mx-auto align-middle mt-8">
                <div className="text-center">
                  <span className="text-2xl xl:text-3xl text-orange-50/80">
                    where the beats never stop
                  </span>
                  <br />
                  <h1 className="uppercase tracking-widest font-extrabold text-[85px] xl:text-9xl text-[#e73d75]">
                    Mixly
                  </h1>
                  <p className="max-w-6xl mx-auto text-sm leading-relaxed text-orange-50/80">
                    Discover the limitless rhythm of Mixly: your go-to platform
                    for free, unlimited streaming and downloading of music and
                    videos. Immerse yourself in a diverse collection of tunes,
                    from classics to the latest hits. Elevate your experience by
                    syncing playlists and playing music together with multiple
                    listeners. Mixly is not just a service; it&apos;s a shared
                    symphony of sound. Enjoy the freedom to explore, connect,
                    and create unforgettable moments—all at your fingertips.
                    Mixly, where the beat never stops, and the experience is
                    always in tune with your passion for music and videos.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <p className="text-orange-50/80">
                Elevate your vibe: Craft a personalized room for music magic
                with your favorite crew. Unleash unforgettable moments in
                harmony!
              </p>
              ...
              {newError && (
                <span className="flex items-center gap-2 text-red-700 rounded-lg justify-center">
                  <MdNearbyError size={20} className="animate-bounce" />{" "}
                  {newError}
                </span>
              )}
            </form>
            ...
            >
              ...
              <p className="text-orange-50/80">
                ...
                curated room, groove with your favorite crew, and share sonic
                bliss together in a pre-made room.
              </p>
              <ul className="text-[#e73d75] list-decimal ml-4">
