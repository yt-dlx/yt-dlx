...
export default function Component() {
  ...
  useEffect(() => {
    if (TubeSearch && ApiSearch.isSuccess) {
      const searchSelect =
        document.getElementById("TubeSearch()");
      if (searchSelect)
        searchSelect.scrollIntoView({ behavior: "smooth" });
    }
    ...
    <main className="overflow-x-hidden max-h-screen scrollbar-thin bg-[#101318] scrollbar-track-[#101318] scrollbar-thumb-pink-600">
      <nav className="navbar bg-[#611952]/10 text-gray-400 backdrop-blur-md fixed z-50 top-0">
        <div className="flex flex-wrap items-baseline justify-center">
          <Link
            href="/"
            className="text-pink-600 cursor-pointer text-3xl mr-2">
            mixly
          </Link>
        ...
        <div className="relative items-center w-full px-5 pb-12 mx-auto">
          <div className="relative h-full flex flex-col items-center justify-center text-center text-[#C4C4C4]">
            <Link
              ...
              <span className="font-bold not-italic text-red-600">
                yt-dlx
              </span>
            </Link>
            ...
            <p className="max-w-6xl -mt-10 mx-auto text-sm xl:text-lg">
              Discover the limitless rhythm of Mixly: your
              go-to platform for free, unlimited streaming
              and downloading of music and videos. Immerse
              yourself in a diverse collection of tunes,
              from classics to the latest hits. Elevate your
              experience by syncing playlists and playing
              music together with multiple listeners. Mixly
              is not just a service; it&apos;s a shared
              symphony of sound. Enjoy the freedom to
              explore, connect, and create unforgettable
              moments—all at your fingertips. Mixly, where
              the beat never stops, and the experience is
              always in tune with your passion for music and
              videos.
            </p>
            <form
              onSubmit={event => {
