 ...
 */
async function ListVideoHighest({ query, verbose, output, useTor, filter, }) {
    try {
        ZodSchema.parse({
            query,
            verbose,
        ...
        for (const video of unique) {
            try {
                ...
                var filename = "yt-dlx_(VideoHighest_";
...
exports.default = ListVideoHighest;
//# sourceMappingURL=ListVideoHighest.js.map