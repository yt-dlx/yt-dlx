 ...
 */
async function ListAudioVideoHighest({ query, verbose, output, useTor, filter, }) {
    try {
        ZodSchema.parse({
            query,
            verbose,
        ...
        for (const video of unique) {
            try {
                ...
                var filename = "yt-dlx_(AudioVideoHighest_";
                var ff = (0, fluent_ffmpeg_1.default)();
                var vdata = engineData.ManifestHigh[engineData.ManifestHigh.length - 1].url;
...
exports.default = ListAudioVideoHighest;
//# sourceMappingURL=ListAudioVideoHighest.js.map