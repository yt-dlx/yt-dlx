...
async function Agent({ query, useTor, verbose, }) {
    ...
    if (verbose) {
        switch (useTor) {
            case true:
                console.log(colors_1.default.green("@info:"), "system", colors_1.default.green("ipAddress"), ipsys);
                console.log(colors_1.default.green("@info:"), "socks5", colors_1.default.green("ipAddress"), iptor);
                break;
            default:
                console.log(colors_1.default.green("@info:"), "system", colors_1.default.green("ipAddress"), ipsys);
                break;
        }
        console.log(colors_1.default.green("@info:"), "is sudo", colors_1.default.green("available"), sudo());
